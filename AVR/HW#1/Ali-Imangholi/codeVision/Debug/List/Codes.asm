...
; 0000 0089          while (1){   //RED LED
; 0000 008A               PORTA.0 =  PINB.0;
	SBIC 0x16,0
	RJMP _0x9
	CBI  0x1B,0
	RJMP _0xA
...
; 0000 0095          break;}
; 0000 0096 
; 0000 0097          while (1){      //RED LED
; 0000 0098               PORTA.0 =  PINB.0;
	SBIC 0x16,0
	RJMP _0x1B
	CBI  0x1B,0
	RJMP _0x1C
...
; 0000 00A1               PORTA.6 = 0;
	CBI  0x1B,6
; 0000 00A2               delay_ms(250);
	LDI  R26,LOW(250)
	LDI  R27,0
	CALL _delay_ms
; 0000 00A3          break;}
; 0000 00A4 
; 0000 00A5          while (1){     //RED LED
; 0000 00A6               PORTA.0 =  PINB.0;
	SBIC 0x16,0
	RJMP _0x2D
	CBI  0x1B,0
	RJMP _0x2E
...
; 0000 00B1          break;}
; 0000 00B2 
; 0000 00B3          while (1){       //RED LED
; 0000 00B4               PORTA.0 =  PINB.0;
	SBIC 0x16,0
	RJMP _0x3F
	CBI  0x1B,0
	RJMP _0x40
